...
def firstaid():
    ...
    print("Plates, Cutlery, and, of course, a manual Can Opener")
    print ("3 days worth of Clothing for everyone in your family \n Eyeglasses/Contacts and Contact Solution \n Necessary Medicines \n Electronics and Chargers \n For Infants: diapers, formula, etc.")
    print("Waterproof Matches, a Whistle, and Strong Tape \n Battery operated or Crank Radio")
...
def flood():
    ...
    print("Clear gutters, downspouts, and drains \n Shut off electricity")
    print("Never drive on flooded roads \n Drive slowly and steadily")
    print("Don’t drive over bridges over fast moving water unless absolutely necessary \n Watch out for downed power lines.")
    print("Check with your local council about local flood plans or records which detail problem areas")
    print("Ask authorities about relocation routes and centers \n If your area is flood prone, consider alternatives to carpets")
    print("Prepare an emergency kit \n Prepare a household flood plan \n Keep a list of emergency telephone numbers on display")
    print("Check your insurance policy to see if you are covered for flood damage \n Secure hazardous items")
    print("Roll up rugs, move furniture, electrical items and valuables to a higher level")
    print("Place important personal documents, valuables and vital medical supplies into a waterproof case in an accessible location")
    print("If you are relocating, take your pets with you if it is safe to do so. If not provide adequate food and water and move them to a safer place")
    print("Monitor Bureau of Meteorology (BoM) forecasts and warnings online and listen to your local ABC Radio")
    print("If rising waters threaten your home and you decide to move to a safer location, tell the police, your nearest State Emergency Service (SES) unit or your neighbors of your plans to move")
    print("Monitor your local radio for warnings and advice \n Pack warm clothing, essential medication, valuables and personal papers in waterproof bags along with your emergency kit")
    print("Raise furniture, clothing and valuables onto beds, tables and into roof space place electrical items in the highest place")
    print("Empty freezers and refrigerators, leaving doors open to avoid damage or loss if they float")
    print("Turn off power, water and gas and take your mobile phone \n Whether you leave or stay, put sand bags in the toilet bowl and over all laundry/bathroom drain holes to prevent sewage backflow")
    print("Lock your home and take recommended relocation routes for your area \n Do not drive into water of unknown depth and current")
    print("Monitor your local radio for warnings and advice \n Get to higher ground")
    print("Switch off electricity and gas supplies to your home \n Prepare to move vehicles, outdoor equipment, garbage, chemical and poisons to higher locations")
    print("Prepare for the well-being of pets")
    print("Raise furniture above likely flood levels \n Check your emergency kit \n Do not allow children to play in or near floodwaters")
    print("Avoid entering floodwaters. If you must do so, wear solid shoes and check depth and current with a stick \n Stay away from drains, culverts and water over knee deep")
    print("Do not use gas or electrical appliances that have been in floodwater until checked for safety")
    print("Do not eat food that has been in floodwaters \n Boil tap water until supplies have been declared safe")
    print("Secure hazardous items \n Roll up rugs, move furniture, electrical items and valuables to a higher level")
    print("Place important personal documents, valuables and vital medical supplies into a waterproof case in an accessible location")
    print("If you are relocating, take your pets with you if it is safe to do so. If not provide adequate food and water and move them to a safer place")
    print("Monitor Bureau of Meteorology (BoM) forecasts and warnings online and listen to your local ABC Radio")
    print("If rising waters threaten your home and you decide to move to a safer location:")
    print("Tell the police, your nearest State Emergency Service (SES) unit or your neighbors of your plans to move.")
    print("Monitor your local radio for warnings and advice \n Pack warm clothing, essential medication, valuables and personal papers in waterproof bags along with your emergency kit")
    print("Raise furniture, clothing and valuables onto beds, tables and into roof space place electrical items in the highest place")
    print("Empty freezers and refrigerators, leaving doors open to avoid damage or loss if they float")
    print("Turn off power, water and gas and take your mobile phone")
    print("Whether you leave or stay, put sand bags in the toilet bowl and over all laundry/bathroom drain holes to prevent sewage backflow")
    print("Lock your home and take recommended relocation routes for your area")
    print("Do not drive into water of unknown depth and current")
...
def wildfire():
    ...
    print("Move flammable furniture to the center of the room, away from windows and doors \n Shut off gas at the meter; turn off pilot lights")
    print("Leave your lights on so firefighters can see your house under smoky conditions")
    print("Shut off the air conditioning")
    print("Outside:")
    ...
    print("Turn off propane tanks")
    print("Move propane BBQ appliances away from structures")
    print("Connect garden hoses to outside water valves or spigots for use by firefighters. Fill water buckets and place them around the house")
    print("Don’t leave sprinklers on or water running, they can affect critical water pressure")
    print("Leave exterior lights on so your home is visible to firefighters in the smoke or darkness of night")
    print("Put your Emergency Supply Kit in your vehicle")
    print("Back your car into the driveway with vehicle loaded and all doors and windows closed. Carry your car keys with you")
    print("Have a ladder available and place it at the corner of the house for firefighters to quickly access your roof")
    print("Seal attic and ground vents with pre-cut plywood or commercial seals")
    print("Patrol your property and monitor the fire situation. Don’t wait for an evacuation order if you feel threatened")
    print("Check on neighbors and make sure they are preparing to leave")
    print("Animals:")
